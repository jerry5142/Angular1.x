...
//-------------------chart object---------------------- 
   var makeChart = function(crossfilter, chartDivId, chartConfig){
      ...
      var dim; //holds dimension for the key field
      var records; //holds the grouped and sorted records
      var chart, margin, width, height, g; //chart and margin vars
      var xScaleFunction; //xaxis scale 
      var barHeight, barSection, barTop, bar; //bar vars

      //---make the chart---   
      function constructor() {
            //create the dimension on the key field
            dim = crossfilter.dimension(function(fact){ return fact[config.key];});
...
//-----------------------------------------
      ...
      constructor.setXaxisValue = function(xAxisValue){
